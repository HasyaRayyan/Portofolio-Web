...
function use3DTilt(ref, strength = 5) {
  useEffect(() => {
    ...
    <section id="home" className="hero-section">
      <div className="container">
        <div className="hero-grid">
          ...
          {/* ── Kanan: Foto dengan Frame Modern Eksklusif ── */}
          <div
          ...
          >
            ...
            <div className="hero-photo-frame">
              ...
              {/* Bottom Caption Pill on Frame */}
              <div className="hero-frame-caption">
                <span className="frame-caption-title">HASYA RAYYAN</span>
                <span className="frame-caption-dot">•</span>
                <span className="frame-caption-sub">SOFTWARE CRAFTSMAN</span>
              </div>
            </div>
          </div>
